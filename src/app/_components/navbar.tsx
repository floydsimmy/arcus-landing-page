...
export const Navbar = () => {
  ...
  return (
    <nav className="flex fixed z-20 lg:top-4 gap-64 lg:pr-[1.375rem]  lg:max-w-[80rem] items-center border bg-white border-blue-arc-100 lg:rounded-[64px] max-md:max-h-14 max-md:px-3">
      ...
      {
          open ? (
            <X weight="bold" size={30} className="lg:hidden"/>
          ) : (
            <List weight="bold" size={30} className="lg:hidden" />
          )
        }
      </button>
