...
export const Navbar = () => {
  ...
  return (
    <nav className="flex fixed z-20 lg:top-4 gap-64 lg:pr-[1.375rem] lg:max-w-[80rem] items-center border-b lg:border border-blue-arc-100 bg-white/85 backdrop-blur-md lg:rounded-[64px] h-20">
      ...
      <ul className={`list-none flex gap-8 max-md:absolute transition-all ease-in max-md:z-[-1] max-md:flex-col max-md:h-screen ${open ? "top-16 opacity-100 pt-8 pb-6 px-4" : "top-[-990px]"} bg-white max-md:w-full `}>
